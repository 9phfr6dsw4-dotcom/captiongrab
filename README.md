...
5. After installing CaptionGrab 1.2.9, open `chrome://extensions` and click **Reload** on the CaptionGrab unpacked extension so Chrome uses the updated transcript panel support. You do not need to remove and re-add it; its extension ID stays the same.
